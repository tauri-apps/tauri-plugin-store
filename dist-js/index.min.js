...
class Store {
     ...
     */
    async set(key, value) {
        return await u$1("plugin:store|set", {
            path: this.path,
            key,
            value,
        });
     ...
     */
    async get(key) {
        return await u$1("plugin:store|get", {
            path: this.path,
            key,
        });
    }
     ...
     */
    async has(key) {
        return await u$1("plugin:store|has", {
            path: this.path,
            key,
        });
    }
     ...
     */
    async delete(key) {
        return await u$1("plugin:store|delete", {
            path: this.path,
            key,
        });
    }
     ...
     */
    async clear() {
        return await u$1("plugin:store|clear", {
            path: this.path,
        });
    }
    /**
     ...
     */
    async reset() {
        return await u$1("plugin:store|reset", {
            path: this.path,
        });
    }
    /**
     ...
     */
    async keys() {
        return await u$1("plugin:store|keys", {
            path: this.path,
        });
    }
    /**
     ...
     */
    async values() {
        return await u$1("plugin:store|values", {
            path: this.path,
        });
    }
    /**
     ...
     */
    async entries() {
        return await u$1("plugin:store|entries", {
            path: this.path,
        });
    }
    /**
     ...
     */
    async length() {
        return await u$1("plugin:store|length", {
            path: this.path,
        });
    }
    /**
     ...
     */
    async load() {
        return await u$1("plugin:store|load", {
            path: this.path,
        });
    }
    /**
     ...
     */
    async save() {
        return await u$1("plugin:store|save", {
            path: this.path,
        });
    }
    /**
