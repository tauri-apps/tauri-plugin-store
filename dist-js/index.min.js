...
class Store {
     ...
     */
    async set(key, value) {
        return await d("plugin:store|set", {
            path: this.path,
            key,
            value,
        });
     ...
     */
    async get(key) {
        return await d("plugin:store|get", {
            path: this.path,
            key,
        });
    }
     ...
     */
    async has(key) {
        return await d("plugin:store|has", {
            path: this.path,
            key,
        });
    }
     ...
     */
    async delete(key) {
        return await d("plugin:store|delete", {
            path: this.path,
            key,
        });
    }
     ...
     */
    async clear() {
        return await d("plugin:store|clear", {
            path: this.path,
        });
    }
    /**
     ...
     */
    async reset() {
        return await d("plugin:store|reset", {
            path: this.path,
        });
    }
    /**
     ...
     */
    async keys() {
        return await d("plugin:store|keys", {
            path: this.path,
        });
    }
    /**
     ...
     */
    async values() {
        return await d("plugin:store|values", {
            path: this.path,
        });
    }
    /**
     ...
     */
    async entries() {
        return await d("plugin:store|entries", {
            path: this.path,
        });
    }
    /**
     ...
     */
    async length() {
        return await d("plugin:store|length", {
            path: this.path,
        });
    }
    /**
     ...
     */
    async load() {
        return await d("plugin:store|load", {
            path: this.path,
        });
    }
    /**
     ...
     */
    async save() {
        return await d("plugin:store|save", {
            path: this.path,
        });
    }
    /**
